...
const ProfilePage: NextPageWithLayout<ProfilePageProps> = ({ user }) => {
  ...
  const onSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    profileMutation.mutate(userData, {
      onSettled: () => {
        setStringifiedUserData(JSON.stringify(userData));
      }
    });
  };
  ...
  return (
    <>
      ...
      <main className="px-3">
        <div className="max-w-[928px] w-full mx-auto bg-gray-2 rounded-lg grid grid-rows-profile overflow-hidden h-max mt-8 mb-8 pb-10">
          <img
          ...
          <Avatar
            ...
            className="mx-auto -mt-[48px] w-24 h-24 !p-1.5 mb-16"
          />

          <form onSubmit={onSubmit} className="flex flex-col items-center justify-center px-4">
